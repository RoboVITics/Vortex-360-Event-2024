          ...
          >
            ...
            <div className="form-group mt-3">
              <div className="card">
                ...
                >
                  <svg
                    class="socialSvg youtubeSvg"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      fill="#FF0000"
                      d="M23.73 7.73c-.27-1.05-1.02-1.89-2.01-2.1C20.6 5.4 12 5.01 12 5.01s-8.6.39-9.72.62c-.99.21-1.74 1.05-2.01 2.1C0 9.42 0 12 0 12s0 2.58.27 3.27c.27 1.05 1.02 1.89 2.01 2.1 1.12.23 9.72.62 9.72.62s8.6-.39 9.72-.62c.99-.21 1.74-1.05 2.01-2.1.27-.69.27-1.27.27-3.27s0-2.58-.27-3.27zm-15.73 7.36V8.9l6.5 3.6-6.5 3.19z"
                    />
                  </svg>
                </a>
                ...
                >
                  <svg
                    class="socialSvg facebookSvg"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      fill="#1877F2"
                      d="M19 2H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h7.65v-7.04h-2.1V9.49h2.1V7.36c0-2.08 1.26-3.22 3.13-3.22.9 0 1.86.16 1.86.16v2.05h-1.04c-1.03 0-1.36.64-1.36 1.3v1.54h2.31l-.36 2.45h-1.95V21h3.86a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3z"
                    />
                  </svg>
                </a>
